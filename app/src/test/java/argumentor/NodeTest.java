...
public class NodeTest {
    ...
    @Test public void testCheckWinnerReturnsCorrectWinner() {
        ...
        assertTrue("Should return testNode2 or testNode3", testNode.checkWinner(0).equals(testNode2) || testNode.checkWinner(0).equals(testNode3));
    }
    ...
    @Test public void testNodeNotEqualIfOtherIsNull() {
        ...
        Node testNode2 = new Node("test");
        assertFalse("Should not be equal", testNode.equals(testNode2));
    }
}
